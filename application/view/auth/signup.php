    ...
    <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        <div class="flex flex-row space-x-6">
          ...
          <div class="basis-1/2">
            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Prénom</label>
            <div class="mt-2">
              <input id="email" name="email" type="email" autocomplete="email" required
                class="block w-full rounded-md border-0 px-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        ...
        <div class=" flex  justify-center mx-auto">
          <button type="submit"
            class="center w-2/4 flex justify-center rounded-lg bg-gradient-to-r from-[#F49867] via-[#D884A2] via-40% to-[#AE67FA] px-3 py-3 text-md font-semibold leading-6 text-white shadow-sm ">Sign
            in</button>
        </div>
      </form>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a href="<?php echo URL; ?>auth/login" class="font-semibold leading-6 text-[#FF6363]">Connectez-vous.</a>
      </p>
      <p class="mt-2 text-center text-sm text-gray-500 hover:text-gray-800 hover:underline ">
        <a href="#" class="font-semibold leading-6  ">Aller espace admin.</a>
      </p>
    </div>
  </div>
</div>