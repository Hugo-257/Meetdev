  ...
  <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="#" method="POST">
      ...
      <div class=" flex  justify-center mx-auto">
        <button type="submit" class="center w-2/4 flex justify-center rounded-lg bg-gradient-to-r from-[#F49867] via-[#D884A2] via-40% to-[#AE67FA] px-3 py-3 text-md font-semibold leading-6 text-white shadow-sm ">Sign in</button>
      </div>
    </form>

    <p class="mt-10 text-center text-sm text-gray-500">
      Vous n'avez pas de compte?
      <a href="<?php echo URL; ?>auth/signup" class="font-semibold leading-6 text-[#FF6363]">Créer nouveau compte.</a>
    </p>
